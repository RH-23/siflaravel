...
@section('title', 'Form Tambah Ingredient')
                ...
                <div class="col-8">
                    ...
                    <form method="POST" action="/ingredients">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('kode_erp') is-invalid @enderror" id="kode_erp" placeholder="Masukkan Kode ERP" name="kode_erp" value="{{ old('kode_erp') }}" autofocus>
                            @error('kode_erp')
                        ...
                        <div class="mb-3">
                            ...
                            <select name="uom_id" class="form-control @error('uom_id') is-invalid @enderror">
                                ...
                                <option value="{{ $item->id }}" {{ old('uom_id') == $item->id ? 'selected' : '' }}>{{ $item->nama }}</option>
                                @endforeach
                            </select>
                            @error('uom_id')
                                <div class="invalid-feedback">
